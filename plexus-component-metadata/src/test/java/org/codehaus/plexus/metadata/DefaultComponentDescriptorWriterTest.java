    ...
    extends PlexusTestCase
{
    ...
    public void testBasic() throws Exception {
        ...
        PlexusConfiguration config = buildConfiguration( "<String Memory Resource>", new StringReader( xml ) );
        ...
        org.codehaus.plexus.component.repository.ComponentSetDescriptor set2 = buildComponentSet(config, realm);
        assertNotNull(set2);
