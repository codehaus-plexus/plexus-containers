...
public abstract class AbstractComponentCollection<T> {
    ...
    public AbstractComponentCollection(
            final MutablePlexusContainer container,
    ...
    protected T lookup(ComponentDescriptor<T> componentDescriptor) {
        ...
        try {
            ...
            logger.debug(
                    "Failed to lookup a member of active collection with role: " + role + " and role-hint: "
