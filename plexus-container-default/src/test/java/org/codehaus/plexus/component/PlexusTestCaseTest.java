...
public class PlexusTestCaseTest extends PlexusTestCase {
    ...
    public void testCustomizeContext() throws ContextException {
        String value = (String) getContainer().getContext().get(CUSTOM_PROPERTY);
